...
//        startMarker.setZIndex(STRTDEST_Z);
    ...
    public void setPoint1(geography.GeographicPoint point) {
    	if(point1Marker!= null) {
            changeIcon(point1Marker, markerURL);
//            point1Marker.setZIndex(DEFAULT_Z);
    	}
    	point1Marker = markerMap.get(point);
//        point1Marker.setZIndex(STRTDEST_Z);
        changeIcon(point1Marker, destinationURL);
    }
    public void setPoint2(geography.GeographicPoint point) {
    	if(point2Marker!= null) {
            changeIcon(point2Marker, markerURL);
//            point2Marker.setZIndex(DEFAULT_Z);
    	}
    	point2Marker = markerMap.get(point);
//        point2Marker.setZIndex(STRTDEST_Z);
        changeIcon(point2Marker, destinationURL);
    }
    
    public void setPoint3(geography.GeographicPoint point) {
    	if(point3Marker!= null) {
            changeIcon(point3Marker, markerURL);
//            point3Marker.setZIndex(DEFAULT_Z);
    	}
    	point3Marker = markerMap.get(point);
//        point3Marker.setZIndex(STRTDEST_Z);
        changeIcon(point3Marker, destinationURL);
    }
    
    public void setPoint4(geography.GeographicPoint point) {
    	if(point4Marker!= null) {
            changeIcon(point4Marker, markerURL);
//            point4Marker.setZIndex(DEFAULT_Z);
    	}
    	point4Marker = markerMap.get(point);
//        point4Marker.setZIndex(STRTDEST_Z);
        changeIcon(point4Marker, destinationURL);
    }
