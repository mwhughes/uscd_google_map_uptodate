...
public class DataSet {
	String filePath;
	roadgraph.mapGraphForSalesmen graph;
    ...
    public void setGraph(roadgraph.mapGraphForSalesmen graph) {
    	this.graph = graph;
    }

    public void setRoads(HashMap<geography.GeographicPoint,HashSet<geography.RoadSegment>>  roads) { this.roads = roads; }
    public roadgraph.mapGraphForSalesmen getGraph(){ return graph; }
    ...
    public void initializeGraph() {
        graph = new roadgraph.mapGraphForSalesmen();
